    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            var mailService = new SmtpMailService(
                host: "smtp.gmail.com",
                port: 587,
                username: "ayala99263@gmail.com",
                password: "dfga rgvt imqh qmxd",
                fromEmail: "ayala99263@gmail.com"
            );

            mailService.Send("5838567@gmail.com", "הפתעה!!!!!!", "שלחתי לך את ההודעה הזו מהפרויקט שלנו, נכון אלוף!!!!");
        }
    }
}
...
//            Participant p1 = new Participant { Id = 201, Name = "יוסי לוי", Email = "yossi@test.com", IsAttending = true, HasPaid = true, AmountContributed = 500m };
//            Participant p2 = new Participant { Id = 202, Name = "דוד כהן", Email = "david@test.com", IsAttending = null, HasPaid = false, AmountContributed = 0m };
//            Participant p3 = new Participant { Id = 203, Name = "יאיר מזרחי", Email = "yair@test.com", IsAttending = false, HasPaid = false, AmountContributed = 0m };
...
//            Poll testPoll = new Poll { Id = 1, Title = "סקר קולינריה חברה", Description = "בחירת אוכל לאירוע" };
...
//            ReceiptDetails newReceipt = new ReceiptDetails
//            {
//                Id = 555,
...
//            IEnumerable<Participant> allParticipants = xmlParticipantRepo.GetAll();
...
//            Participant p1 = new Participant { Id = 101, Name = "מאיר כהן", Email = "meir@test.com", IsAttending = true, HasPaid = true, AmountContributed = 200m };
//            Participant p2 = new Participant { Id = 102, Name = "חנה לוי", Email = "chana@test.com", IsAttending = null, HasPaid = false, AmountContributed = 0m };
//            Participant p3 = new Participant { Id = 103, Name = "שמעון מזרחי", Email = "shimon@test.com", IsAttending = false, HasPaid = false, AmountContributed = 0m };
