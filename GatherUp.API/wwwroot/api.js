...
async function getMyParticipation(eventId) { return apiCall('GET', `/participants/event/${eventId}/me`); }
...
async function updatePayment(eventId) { return apiCall('PATCH', `/participants/event/${eventId}/payment`); }
async function updateNotifications(eventId, value) { return apiCall('PUT', `/participants/event/${eventId}/notifications`, { notificationSettings: value }); }
...
async function submitPollAnswer(pollId, answers) { return apiCall('POST', `/polls/${pollId}/answer`, { answers }); }
